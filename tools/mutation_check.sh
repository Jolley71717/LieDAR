...
CASES=(
  "Sources/LieDARSynthetic/Anchors/AnchorChunker.swift~            blocks[b].shift += translation~~AnchorChunkerTests/testLoopClosureTranslatesEveryAnchorAtOnce~loop closure translation~A: loop-closure translation"
  "Sources/LieDARSynthetic/Realism/DegradationModel.swift~                out[i] = MeshClassification.none.rawValue~~DegradationTests/testUnlabelledFractionMatchesTheModelForASeed~unlabelled fraction~B: degradation model"
  ...
  "Sources/LieDARSynthetic/Render/Raycaster.swift~        public init(highRange: Float = 3.0, mediumRange: Float = 5.0, highCosine: Float = 0.5, mediumCosine: Float = 0.2) {~        public init(highRange: Float = 3.0, mediumRange: Float = 5.0, highCosine: Float = 0.5, mediumCosine: Float = 0.0) {~RaycasterTests/testConfidenceMatchesGoldenBytes~corridor pixel (105, 96)~D: confidence mediumCosine 0.2 -> 0.0"
  "Sources/LieDARSynthetic/Render/Raycaster.swift~    private static let seamTolerance: Float = 1e-5~    private static let seamTolerance: Float = 0~RaycasterTests/testRayOnASharedEdgeStillHits~shared edge~E: shared-edge pass seamTolerance 1e-5 -> 0"
